...
export enum PermissionFlags {
  ...
  FILE_READ = 1 << 8,
  FILE_MODIFY = 1 << 9,
  STAFF_READ_ACCOUNTS = 1 << 10,
  STAFF_MODIFY_ACCOUNTS = 1 << 11,
  STAFF_READ_SECOND_FACTORS = 1 << 12,
  STAFF_MODIFY_SECOND_FACTORS = 1 << 13,
  STAFF_READ_SESSIONS = 1 << 14,
  STAFF_MODIFY_SESSIONS = 1 << 15,
  STAFF_READ_FILES = 1 << 16,
  STAFF_MODIFY_FILES = 1 << 17,
  STAFF_MODIFY_DOMAINS = 1 << 18,
  STAFF_MODIFY_INSTRUCTIONS = 1 << 19,
  STAFF_MODIFY_KILLSWITCHES = 1 << 20,
}
